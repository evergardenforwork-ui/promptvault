...
2. **Раскрывающиеся аккордеоны подробностей**:
...
3. **Умная система тегов**: тегов может быть сотни — поиск по облаку тегов, автодополнение при вводе.
4. **🪄 Gemini AI Smart Parser (ИИ Автозаполнение в 1 клик)**:
