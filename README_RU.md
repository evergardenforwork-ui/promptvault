...
- **Каталог полезных сайтов, сервисов и браузерных закладок**:
  - **Двухуровневая система организации (как в браузере)**:
    - **Папки-вкладки верхнего уровня**: Дизайн, OSINT, 1C Предприятие, ИИ, Dev, Документация + создание своих папок (`+ Создать папку`).
    - **Подкатегории внутри папок**: создание и фильтрация вложенных подразделов (например «1С» → `1С База`, `Отчёты`, `Конфигурации`).
